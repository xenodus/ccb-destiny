...
<section class="stats text-center container-fluid mb-4">
  ...
  <div class="mt-4">
    @include('stats.breadcrumbs', ['nav_link' => '/stats/trials', 'nav_name' => 'Trials'])
    <h1 class="text-yellow text-left">Trials Stats</h1>
  </div>
...
@section('footer')
<script src="{{ mix('/js/compiled/trials_numbers.js') }}"></script>
@endsection