...
class UpdateClanGambitPrimeActivityBuddies extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'update:clanGambitPrimeActivityBuddies';
     ...
     * @var string
     */
    protected $description = 'Update members\' gambit prime  activity buddies';
    ...
    public function handle()
    {
        ...
        if( $members->count() > 0 ) {
            ...
            $this->info('Begin: Clan Gambit Prime Activity Buddy');
            ...
            $this->info('Completed: Clan Gambit Prime Activity Buddy');
        }
