...
class UpdateClanPvPActivityBuddies extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'update:clanPvPActivityBuddies';
     ...
     * @var string
     */
    protected $description = 'Update members\' pvp activity buddies';
    ...
    public function handle()
    {
        ...
        if( $members->count() > 0 ) {
            ...
            $this->info('Begin: Clan PvP Activity Buddy');
                        ...
                        if( $response->getStatusCode() == 200 ) {
                            ...
                            if( isset( $response['Response']->activities ) ) {
                                ...
                                foreach( $response['Response']->activities as $activity ) {
                                    ...
                                    // Helper Text
                                    $this->info('Processing '.($activities_index++).' of '.count($response['Response']->activities).' activities: '.$activity_id);
